package DynamicProgramming_4.PresentBriefly_1.前缀和.运算推广.运算推广问题_前缀积.乘积小于K的子数组;
...
//        int n = nums.length;
//
//        long[] prefixProduct = new long[n + 1];  // 前缀积数组
//
//        prefixProduct[0] = 1;  // 初始第一个元素 1
//
//        // 计算前缀积
//        for (int i = 0; i < n; i++) {
...
//
//                // 子数组乘积
//                long product = prefixProduct[end + 1] / prefixProduct[start];
//
//                if (product < k) {
//                    count++;
//                } else {
